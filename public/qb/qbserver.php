		...
		<QBXMLMsgsRq onError="stopOnError">
			<InvoiceAddRq requestID="'.$reqid.'">
				<InvoiceAdd>
					...
					<TxnDate>2011-08-31</TxnDate>
					<BillAddress>
						<Addr1>Eco-Energy '.$ID.'</Addr1>
						<Addr2>725 Cool Springs Blvd., Suite 500</Addr2>
						<City>Franklin</City>
						<State>TN</State>
						<PostalCode>37067</PostalCode>
					</BillAddress>
					<ShipAddress>
						<Addr1>Magellan Terminal</Addr1>
						<Addr2>401 East Donavon</Addr2>
					...
					<InvoiceLineAdd>
						...
						<RatePercent>33.50000</RatePercent>
					</InvoiceLineAdd>
				</InvoiceAdd>
			</InvoiceAddRq>
		</QBXMLMsgsRq>
...
fclose($fp);
	...
	public function handleError500($requestID, $user, $action, $ID, $extra, &$err, $xml, $errnum, $errmsg)
	{
		...
		return true;			// If you return FALSE, it will stop processing requests
	}
...
if (!QuickBooks_Utilities::initialized($dsn))
{
	...
	$xml = '<?xml version="1.0" encoding="utf-8"?>
			...
			<QBXML>
				<QBXMLMsgsRq onError="stopOnError">
					<CustomerAddRq>
						<CustomerAdd>
							<Name>ConsoliBYTE Solutions </Name>
							<CompanyName>ConsoliBYTE Solutions</CompanyName>
							<FirstName>Keith</FirstName>
							<LastName>Palmer</LastName>
							<BillAddress>
	...
	$Queue = new QuickBooks_Queue($dsn);
	$Queue->enqueue(QUICKBOOKS_ADD_CUSTOMER, $primary_key_of_your_customer,0,null,null,$xml);
	...
	<QBXML>
		<QBXMLMsgsRq onError="stopOnError">
			<InvoiceAddRq>
				<InvoiceAdd>
					<CustomerRef>
						<FullName>Eco-Energy</FullName>
					</CustomerRef>
					<BillAddress>
						<Addr1>Eco-Energy</Addr1>
						<Addr2>725 Cool Springs Blvd., Suite 500</Addr2>
						<City>Franklin</City>
						<State>TN</State>
						<PostalCode>37067</PostalCode>
...
$Queue = new QuickBooks_Queue($dsn);
//$Queue->enqueue(QUICKBOOKS_ADD_INVOICE,2,0,null,null,$xml);
*/	
/*
		$xml = '<?xml version="1.0" encoding="utf-8"?>
			<?qbxml version="2.0"?>
			<QBXML>
				<QBXMLMsgsRq onError="stopOnError">
					<CustomerAddRq>
						<CustomerAdd>
							<Name>ConsoliBYTE Solutions </Name>
							<CompanyName>Brian Cryderman</CompanyName>
							<FirstName>Keith</FirstName>
							<LastName>Palmer</LastName>
							<BillAddress>
								<Addr1>ConsoliBYTE Solutions</Addr1>
