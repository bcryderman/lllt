...
class LLLT_Model_NavmanCancel {

	protected $_navman_cancel_id;
	protected $_load_id;
	protected $_emp_id;
    ...
    public function setOptions(array $options) {
 	...
 	public function setNavman_cancel_id($val) {
    	
        $this->_navman_cancel_id = $val;
        
        return $this;
    }
 
    public function getNavman_cancel_id() {
    	
        return $this->_navman_cancel_id;
    }
